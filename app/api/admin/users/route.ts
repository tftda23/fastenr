...
export async function POST(request: NextRequest) {
  try {
    ...
    const link = `${process.env.NEXT_PUBLIC_APP_URL || process.env.APP_BASE_URL || (process.env.NODE_ENV === 'development' ? "http://localhost:3000" : "https://fastenr.com")}/invite?token=${inv.token}`
